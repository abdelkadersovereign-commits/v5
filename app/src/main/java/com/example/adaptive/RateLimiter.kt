package com.example.adaptive
   ...
   * Policy: max 3 requests per 3-hour rolling window.
  ...
  object RateLimiter {
      ...
      private const val WINDOW_MS    = 3L * 60 * 60 * 1000  // 3 hours
       ...
       * Returns 0 if the window has already expired (i.e., user is free to request).
       */
