...
class NotificationWorker(context: Context, params: WorkerParameters) : CoroutineWorker(context, params) {
    ...
    override suspend fun doWork(): Result {
        ...
        // 2. Device Security Scan
        performDeviceSecurityScan(isAr)

        // 3. Gemini Security Alert (if API key available)
    ...
    private fun performDeviceSecurityScan(isAr: Boolean) {
        ...
        // Check installed apps for dangerous permissions
        ...
        // Check if unknown sources / install from unknown sources is enabled
